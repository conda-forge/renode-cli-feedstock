...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/renode-cli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/renode-cli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install renode-cli
```
...
It is possible to list all of the versions of `renode-cli` available on your platform:
...
```
pixi search renode-cli --channel conda-forge
```
