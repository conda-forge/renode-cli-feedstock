...
(Get-Content $SRC_DIR/src/Infrastructure/src/UI/UI.csproj) -replace "(<\/PropertyGroup>)", "    <UseWPF>true</UseWPF>`n`$1" | Set-Content $SRC_DIR/src/Infrastructure/src/UI/UI.csproj
